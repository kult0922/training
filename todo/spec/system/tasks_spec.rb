...
RSpec.describe Task, type: :system do
  ...
  describe '#index' do
    before { visit tasks_path(project_id: task.project.id) }
  ...
  describe '#new' do
    before { visit new_task_path(project_id: task.project.id) }
  ...
  describe '#edit' do
    before { visit edit_task_path(task.id, project_id: task.project.id) }

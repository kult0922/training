  ...
  describe 'task where' do
    context 'when task search' do
      ...
      it 'search task_name' do
        ...
        get_name1 = Task.name_search(search_word1)
        ...
        get_name2 = Task.name_search(search_word2)
      ...
      it 'search status' do
        todo_task = Task.sta_search(:todo)
        ...
        in_progress_task = Task.sta_search(:in_progress)
        ...
        done_task = Task.sta_search(:done)
      ...
      it 'search priority' do
        low_priority_task = Task.pri_search(:low)
        ...
        mid_priority_task = Task.pri_search(:mid)
        ...
        high_priority_task = Task.pri_search(:high)

...
- [x] ステップ4: 作りたいアプリケーションのイメージを考える  ->  Todo app
- [x] ステップ5: データベースの接続設定（周辺設定）をしましょう
- [x] ステップ6: タスクモデルを作成しましょう
- [x] ステップ7: タスクを登録・更新・削除できるようにしよう
- [x] ステップ8: テスト(system spec)を書こう
- [x] ステップ9: アプリの各種設定を行いましょう
- [x] ステップ10: タスク一覧を作成日時の順番で並び替えましょう ★ スキップ可能
- [x] ステップ11: バリデーションを設定してみよう
- [x] ステップ12: 終了期限を追加しよう ★ スキップ可能
- [x] ステップ13: ステータスを追加して、検索できるようにしよう
- [x] ステップ14: ページネーションを追加しよう
- [x] ステップ15: デザインを当てよう ★ スキップ可能
- [x] ステップ16: 複数人で利用できるようにしよう（ユーザの導入）
- [x] ステップ17: ログイン/ログアウト機能を実装しよう
- [x] ステップ18: ユーザの管理画面を実装しよう ★ スキップ可能
- [ ] ステップ19: ユーザにロールを追加しよう ★ スキップ可能
- [x] ステップ20: タスクにラベルをつけられるようにしよう
- [ ] ステップ21: メンテナンス機能を作ろう
